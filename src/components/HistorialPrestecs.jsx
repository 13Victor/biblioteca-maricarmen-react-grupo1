        ...
        <tbody>
          {currentItems.map((prestec) => (
            <tr key={prestec.prestec_id}>
              ...
              <td>
                {new Date(prestec.data_prestec).toLocaleDateString()} <span>&nbsp; ({getTimeAgo(prestec.data_prestec)})</span>
              </td>
              <td>
              {prestec.data_devolucio ? 
                <>
                  {new Date(prestec.data_devolucio).toLocaleDateString()} <span>&nbsp; ({getTimeAgo(prestec.data_devolucio)})</span>
                </> 
                : '-'}
              </td>
              <td>
